...
Step 3) Select the region of focus. In this case, it is Victroria.
...
Step 4) Enter the number of topics you want identified. The default it three topics.
...
![](images/topicmodel.png){width=60%}

# Multiple Linear Regression

## Regression for Price

![](images/mlr.png){width=60%}
