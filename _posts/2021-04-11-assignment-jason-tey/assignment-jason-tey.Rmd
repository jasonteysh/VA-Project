...
When zoomed in to the Victoria state boundary (see below), it is not surprising that these areas highlighted are also areas that have shown up earlier when we plotted the p-value, since insignificant values are eliminated in both viz.  
