...
```{r}
packages <- c("tidyverse", "plotly", "purrr", "dplyr", "gdata", "corrplot", "MASS", "biganalytics", "parallelPlot", "factoextra", "factoextra", "gridExtra", "cluster", "forcats")
...
ggplot(unique_host_id_aus,aes(x=(reorder(region_parent_name,-number.of.host)),y=number.of.host))+
  geom_col() +
...
ggplot(unique_id_aus,aes(x=(reorder(region_parent_name,-number.of.listings)),y=number.of.listings))+
  geom_col() +
...
ggplot(unique_id,aes(x=(reorder(region_name,-number.of.listings)),y=number.of.listings))+
  geom_col() +
...
ggplot(bivariateplot,aes(review_scores_rating))+
  geom_density()+
