...
The abundance of Airbnb data provides us with a great opportunity to perform clusters analysis and geospatial clustering of rental units within the geographical scope of this project. It also allows us to review variables that lead to better reviews and pricing strategies through multilinear regression and text analysis.
