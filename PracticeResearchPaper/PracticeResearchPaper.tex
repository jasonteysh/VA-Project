...
rental market. The dataset that has be scrapped on the Airbnb web and
made publicly available by Inside Airbnb provides geospatial, textual,
and quantitative data on each of the listings listed on the web. This
project provides an analytics platform for interested parties
(especially non-data specialists) to conduct exploratory spatial data,
text, cluster, and regression analysis on the Australia Airbnb dataset
using simple and user-friendly interactive dashboards that does not
