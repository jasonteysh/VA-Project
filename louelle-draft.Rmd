...
regionfilter <- filter(airbnb,(airbnb$region_parent_name == input$variable_region))
...
regionfilterX <- filter(airbnb,(airbnb$region_parent_name == input$variable_region))
...
regionfilterY <- filter(airbnb,(airbnb$region_parent_name == input$variable_region))
...
output$corrplotEDA <- renderPlot({
  airbnb.cor <- select(airbnb,c(11, 12, 15, 24, 26, 27, 29, 43, 48, 49, 50, 51, 52, 53, 54))
